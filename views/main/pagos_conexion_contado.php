...
include "obtenerPagosContado.php";
include "stats_cobros_conexion.php";
?>

<div class="container-fluid px-4">
    <h1 class="mt-4">Pagos Conexiones al Contado</h1>
    <!-- Chart -->
    <div class="row mt-5 mb-5">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <ol class="breadcrumb mb-4 shadow-sm">
                <li class="breadcrumb-item active">Resumen cobros por conexión al contado</li>
            </ol>
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between shadow-sm">
                        <h6 class="m-0 font-weight-bold text-primary">Conexión al Contado</h6>
...
<script>
    var cob_con_cont = JSON.parse("<?= json_encode($stats_cobros_conexion['resumen_conexion_contado']) ?>");
</script>
